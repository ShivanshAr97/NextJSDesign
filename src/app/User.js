...
const User = () => {
    return (
        <div className='h-[100%] w-[23%] border-gray-300 shadow-lg'>
            ...
            <div className='flex flex-col mt-2 justify-center'>
                ...
                <div className='rounded-bl-full absolute rounded-br-full rounded-tl-full border-b-4 mx-16 -mt-16 border-l-4 border-blue-300 p-16'></div>
